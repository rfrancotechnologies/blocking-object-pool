...
namespace BlockingObjectPool
{
    ...
    internal class GenericObjectPool<T> : IObjectPool<T> where T : class
    {
        ...
        private readonly Dictionary<T, bool> idleObjects;
        ...
        public T Acquire()
        {
            ...
            do
            {
                ...
                else
                {
                    ...
                    {
                        Interlocked.Increment(ref acquiredInvalidCounter);
                        ...
                        if (acquiredInvalidCounter >= AcquiredInvalidLimit) {
                            throw new InvalidOperationException($"Unable to create a valid object after {acquiredInvalidCounter} attempts.");
                        }
                    }
                    else
                    {
